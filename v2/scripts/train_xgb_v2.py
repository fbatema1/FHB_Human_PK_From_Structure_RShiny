"""
training/train_xgb_scaffold.py
=====================
...
SAVE_DIR = ROOT / "models/saved/v2_xgb"
...
def train_xgb():
    ...
    featurizer: RDKitFeaturizer = RDKitFeaturizer.load(str(PROC / "v2_featurizer.pkl"))
    ...
    for param_idx, param_name in enumerate(PARAMS):
        ...
        rf_feat_path = PROC / f"v2_featurizer_{param_name}.pkl"
        ...
        res_train = evaluate(y_tr, y_pred_tr, param_name=f'XGB {param_name} [TRAIN]', log_scale=True)
        ...
        gmfe_gap = res_train['gmfe'] / results['gmfe']
        if gmfe_gap < 0.7:
