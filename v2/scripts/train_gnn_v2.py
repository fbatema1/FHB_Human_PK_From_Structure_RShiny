"""
training/train_gnn_scaffold.py
=====================
...
Data:
  - Reads pre-built PyG graph lists: v2/data/processed/train_graphs.pt
                                      v2/data/processed/test_graphs.pt
...
# ── Paths ─────────────────────────────────────────────────────────────────────
PROC     = ROOT / "v2/data/processed"
SAVE_DIR = ROOT / "models/saved/v2_gnn"
...
def train_gnn():
    ...
    train_graphs: list = torch.load(str(PROC / "v2_train_graphs.pt"), weights_only=False)
    test_graphs:  list = torch.load(str(PROC / "v2_test_graphs.pt"),  weights_only=False)
