...
SAVE_DIR = ROOT / "models/saved/scaffold_gnn"
...
def train_gnn():
    ...
    train_graphs: list = torch.load(str(PROC / "scaffold_train_graphs.pt"), weights_only=False)
    test_graphs:  list = torch.load(str(PROC / "scaffold_test_graphs.pt"),  weights_only=False)
